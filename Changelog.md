...
- *Редактор*
    ...
    - Добавлена возможность сконструировать собственный плагин (Custom) или изменить параметры существующего.
    - Переделана настройка конфигурации плагина для использования с разными аккаунты
