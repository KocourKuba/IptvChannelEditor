...
- *Редактор*
	...
	- Пути в настройках можно ввести вручную. Например для задания относительных путей в Portable варианте
	- Добавлена возможность сделать Portable вариант редактора. Для этого добавлен ключ запуска /MakePortable
	  При запуске с этим ключом редактор создаст файл конфигурации Settings.cfg.
	  При последующем запуске, если редактор обнаруживает этот файл, то настройки из реестра игнорируются, настройки читаются и сохраняются только в файл настроек.
