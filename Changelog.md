...
### Версия 2.5.678
- *Редактор*
	- Если в информация о канале содержит HEVC то в плейлисте это канал подсвечивается
	- Просмотр всего EPG канала по кнопке View EPG
- *Плагины*
	- Добавлены новые иконки категорий
	- Переделан экран настроек плагина
