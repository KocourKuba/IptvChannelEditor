...
### Версия 5.3.1180
- *Редактор*
  - Возможность принудельно обновить иконку канал. Если не редактор не смог загрузить с первого раза
  - Возможность задать произвольную ссылку на архив
  ...
  - Custom Plugin: Поддержка Custom Archive Url
  - Custom Plugin: добавлен параметр Duration
  - Custon Plugin: обработка тэга tag-chno
...
- *Плагины*
  ...
  - На экране списка категорий возможность вызвать настройки плагина через кнопку Green и обновить через кнопку Yellow 
  - Исправлена история просмотра для сериалов
  - Исправлены проблемы с glanz Медиатекой
  - Исправлена обработка ссылок на VOD из медиатеки fox/smile/ping
