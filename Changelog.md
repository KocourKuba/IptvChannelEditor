...
### Версия 6.6.1642
- *Редактор*
  - Настройка для работы с https proxy убрана из редактора. Теперь этим занимается сам плагин
  - Убрана настройка в конфигурации плагина - cgi scripts. Теперь все файлы задаются в настройке 'Additional files'
  - Прямые ссылки не отображались корректно при изменении, только после закрытия/открытия настроек аккаунта

- *Плагины*
  - Для старых дюн (на SMP86xx) плагин автоматически включает https прокси если это необходимо
  - Еще одно уточнение для сбора лога на некоторых моделях Dune
...
- *Плагины*
  - При вводе пустого пароля для взрослых каналов - пароль отключается
