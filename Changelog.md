...
### Версия 6.6.1680
- *Редактор*
  - Поддержка дополнительных макросов \{API_URL}, \{PL_DOMAIN}, \{EPG_DOMAIN}, \{VOD_DOMAIN}, \{VAR3}
  - Возможность отключить показ информации о подписке/балансе в плагине
  - Небольшие правки в UI
  - Добавлены вторичные источники EPG для antifriz, cbilling, 1usd, tvteam
