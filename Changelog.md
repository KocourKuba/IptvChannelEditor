...
### Версия 2.4.626
- *Редактор*
	- Поддержка встраивания ключа VPortal в список каналов для iEdem/iLook TV
	- Установка путей по умолчанию при чистой установке
- *Плагины*
	- Поддержка встраивания ключа VPortal в список каналов для iEdem/iLook TV
	- Отключение принудительного показа настроек если используется только встроенные в список ключи/токены
	- Обновлены каналы
