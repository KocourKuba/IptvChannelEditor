...
require_once 'screens_vod/starnet_vod.php';
...
require_once 'screens_setup/starnet_interface_setup_screen.php';
require_once 'screens_setup/starnet_interface_newui_setup_screen.php';
require_once 'screens_setup/starnet_epg_setup_screen.php';
require_once 'screens_setup/starnet_provider_setup_screen.php';
require_once 'screens_setup/starnet_streaming_setup_screen.php';
require_once 'screens_setup/starnet_ext_setup_screen.php';
...
class Starnet_Plugin extends Default_Dune_Plugin
{
    ...
    public function __construct($plugin_cookies)
    {
        ...
        $this->create_screen(new Starnet_Provider_Setup_Screen($this));
