...
### Версия 9.3.2530
- *Редактор*
  - Добавлен показ постера телепередачи в просмотрщике EPG (если таковой есть)
  - Добавлена очистка лога редактора после обновления

- *Плагины*
  - Исправлена ошибка загрузки xmltv

### Версия 9.3.2526
- *Редактор*
  - Добавлен поиск EPG ID по имени канала для Интернет источника

- *Плагины*
  - Добавлен поиск EPG ID по имени канала для Интернет источника. (Для моего EPG сервера)
  - Для некоторых Интернет источников добавлен разбор описания для корректного заполнения данных расширенного EPG

### Версия 9.3.2514
- *Плагины*
  - Исправлена ошибка разбора JSON EPG

### Версия 9.3.2512
- *Редактор*
  - Обновлены конфигурации для своего EPG сервера

- *Плагины*
  - Поддержка схемы для Интернет сервера EPG iptx.one

### Версия 9.3.2508
- *Редактор*
  - поддержка VOD для Yosso изменена с Jellyfin на m3u
  - Добавлен домен плейлиста для TV Team
  - Добавлен дополнительный плейлист VOD для RU TV
  - Обновлены конфигурации для ITV Live/Sharavoz/Uspeh

- *Плагины*
  - поддержка VOD для Yosso изменена с Jellyfin на m3u
  - Возвращена кнопка сброса по умолчанию при выборе файлов/папок

### Версия 9.2.2500
- *Редактор*
  - Дополнительная проверка содержимого скачивания плейлиста
  - Удалена поддержка устройств Cbilling/Antifriz
  - Добавлена поддердка таймаутов соединения/скачивания

# Версия 9.2.2494
- *Редактор*
  - Исправлен regex для разбора ссылки ITV Live
  - Исправлена ошибка разбора VOD Sharavoz
  - Отключено определение расширения для потока VOD Sharavoz
  - Добавлен новый сервер плейлиста для Yosso
  - Новая конфигурация плагина не появлялась после добавления
  - Добавлены новые цвета для подсвечивания типа потока канала (UHD (2160) для кодека H.264) и для каналов для которых нет информации о потоке
  - Убран интернет источник для ITPV Online

- *Плагины*
  - Исправлена ошибка фильтра VOD Edem (не показывался самый первый фильм)
  - Отключено определение расширения для потока VOD Sharavoz
  - Добавлен пункт в контекстное меню плагина для принудительного открытия списка категорий
  - Расширен диапазон кэширования EPG для интернет источников. До 7 дней

### Версия 9.2.2478
- *Редактор*
  - Исправлено падение при вызове VOD Cbilling/Antifriz
  - Исправлено падение при при загрузке xmltv от VivaMax

### Версия 9.2.2472
- *Редактор*
  - Поддержка провайдера Allway TV
  - Поддержка провайдера IPTV Cinema
  - Обновлены библиотеки иконок категорий

### Версия 9.2.2464
- *Редактор*
  - Исправлена ошибка переключения аккаунтов
  - Добавлен новый домен для Glanz (на новом домене для Glanz не работает Медиатека! Возможно будет в будущем)
  - Изменены ссылки для плейлистов для Uspeh (добавлена настройка выбора домена плейлиста)
  - Исправлена ошибка с добавлением лишних файлов в плагин если до этого генерился другой

- *Плагины*
  - Добавлена возможность отключить NewUI
  - Добавлена настройка таймаутов скачивания

### Версия 9.2.2458
- *Редактор*
  - Добавлена поддержка медиатеки Yosso
  - Добавлена поддержка медиатеки IpStream
  - Исправлена загрузка медиатеки CBilling
  - Добавлен интернет источник EPG для TV Boom
  - Добавлена поддержка смены сервера вещания для Vivamax
  - Добавлена поддержка смены домена плейлиста для SatQ

- *Плагины*
  - Добавлена поддержка медиатеки Yosso
  - Добавлена поддержка медиатеки IpStream
  - Исправлена ошибка выбора качества в медиатеке Edem
  - Исправлена ошибка пропадания настройки показа Ext EPG
  - Добавлен фильтр по стране для Sharaclub/IpStream/Glanz
  
### Версия 9.1.2446
- *Редактор*
  - Добавлена новая настройка Домен API, поскольку у некоторых провайдеров есть отличия от Домена плейлиста.
  - Исправлены ошибки кэширования данных. Из за этого некоторые медиатеки не работали
  - Обновлены конфигурации для ShuraTV, TVTeam, IPTV Online

- *Плагины*
  - Добавлена новая настройка Домен API
  - Немного переделан экран настроек
  - Исправлена ошибка выбора утилиты Curl для старых типов приставок
  - Исправлено падение на экране выбора файла
  - Исправлено падение если возникала проблема загрузки списка каналов
  - Исправлена ошибка в медиатеке Edem. Не показывался самый первый фильм в списке
  
### Версия 9.0.2428
- *Редактор*
  - Поддержка провайдера TV Boom (https://tvboom.vip/)
  - Исправлены падения при проверки наличия нужных файлов и каталогов

- *Плагины*
  - Поддержка провайдера TV Boom (https://tvboom.vip/)
  - Неправильно работало автоматическое кэширование XMLTV источников
  - Добавлены дополнительные иконки для категорий

### Версия 9.0.2418
- *Редактор*
  - Исправлена ошибка 'Missing Update.xml'
  - При смене xmltv источника не обновлялся EPG

- *Плагины*
  - Дополнительная обработка ошибок распаковки xmltv.

### Версия 9.0.2412
- *Редактор*
  - Поддержка провайдера VivaMax (https://t.me/vivamax_portal)
  - Исправлена ошибка слишком частого обновления прогресса скачивания

### Версия 9.0.2408
- *Редактор*
  - Не запускался процесс обработки xmltv после добавления в список источников
  - Информация о сервере/домене и т.д. не обновлялась если изменялась на стороне сервера
  - Добавлена возможность выбора домена для IPTV Online

- *Плагины*
  - Подстройка начала дня в зависимости от часового пояса (рекомендации DuneHD)

### Версия 9.0.2396
- *Редактор*
  - Исправлена ошибка приводящая к падению редактора при получении информации о потоке канала
  - В настройках программы добавлена закладка настроек цвета
  - Кнопка обновить каналы по умолчанию так же удаляет неизвестные каналы
  - Добавлена возможность включать/выключать подсветку свойств канала (HD/FHD/HEVC). Данные берутся из информации о потоке (требуется установленная программа ffprobe, для получения информации о потоке. Ссылка есть в настройках)
...
### Версия 9.0.2388
- *Редактор*
  - Переработан алгоритм загрузки/парсинга EPG/XMLTV. Теперь большая часть операций делается в фоне и не замораживает основное окно
  - Не работала подсветка некоторых изменных данных плейлиста
  - Добавлен интернет источник для провайдеров SatQ, RU.TV, Uspeh
  - Добавлены плейлисты зеркала epg.one (Edem). У кого проблемы с основным - используйте зеркальные варианты
  - Удален провайдер HN Media (судя по всему теперь это только KLI Media)
  - Изменена иконка по умолчанию для канала если ее нет в плейлисте 
  - Показывается дополнительная информация, если EPG не существует или не найден
  - Добавлена общая с ProIPTV библиотека иконок IPTV Channels Editor. Чтобы можно было ее обновлять отдельно от выпуска новой версии редактора 

- *Плагины*
  - Для новых устройств Dune HD больше не используется костыль в ввиде вызова системной утилиты для скачивания
  - Обновлен диалог информации о канале (как в ProIPTV)
  - В настройках EPG выбор между Интернет источником и XMLTV теперь всегда есть.

### Версия 9.0.2350
- *Редактор*
  - Не работал просмотрщик EPG

### Версия 9.0.2348
- *Редактор*
  - Добавлена поддержка сдвига EPG с точностью до 5 минут и максимальным диапазоном +/- 23 часа 55 минут
  - Для Sharaclub в просмотре медиатеки есть возможность выбирать сериалы
  - Большинство долгих загрузок теперь не замораживают интерфейс
  - Обновлена конфигурация для KLI Media
  - Добавлены домены для Sharavoz
  - Изменнен источник EPG для PeakTV
  - Исправлена ссылка на плейлист для Russkoe TV
  - Исправлена ссылка на API для Sharaclub
  - Убран сервер обновлений igores
  - Убран интернет источник EPG от sharavoz

- *Плагины*
  - Добавлена поддержка сдвига EPG редактора. Новая версия списков каналов. Требуется перегенерить плагин для использования новых возможностей
  - Добавлена возможность настраивать время кэширования плейлиста. От 1 часа до 7 суток. См. настройки проигрывания
  ...
  - Перенесены изменения для медиатеки из ProIPTV

### Версия 9.0.2312
- *Редактор*
  - Переработана работа с конфигурацией плагинов. Теперь если провайдер не требует написания специальных алгоритмов в редакторе его поддержка может быть добавлена только через конфигурацию без перекомплияции редактора.

### Версия 8.7.2308
- *Редактор*
  - Поддержка провайдера Skaz TV (Клон TV Team)
- *Плагины*
  - Поддержка провайдера Skaz TV (Клон TV Team)

### Версия 8.7.2304
- *Плагины*
  - Символ | ломал дюновский механизм локализации
  - Исправлен показ количества каналов для категорий Избранное/Все каналы

### Версия 8.7.2298
- *Редактор*
  - BlinkTV заменен на ReflexTV (переименовались)
  - Изменен вторичный EPG для Sharavoz
