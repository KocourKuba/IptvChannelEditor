...
class Starnet_Vod extends Abstract_Vod
{
    ...
    const VOD_HISTORY_LIST = 'vod_history_items';
    ...
    {
        $fav_movie_ids = HD::get_items(self::VOD_FAVORITES_LIST . "_" . $this->plugin->config->get_vod_template_name($plugin_cookies), true);
    ...
    {
        HD::put_items(self::VOD_FAVORITES_LIST . "_" . $this->plugin->config->get_vod_template_name($plugin_cookies), $fav_movie_ids);
    }
    ...
    {
        HD::put_items(self::VOD_HISTORY_LIST . "_" . $this->plugin->config->get_vod_template_name($plugin_cookies), $history_items);
    }

    protected function load_history($plugin_cookies)
    {
        $history_items = HD::get_items(self::VOD_HISTORY_LIST . "_" . $this->plugin->config->get_vod_template_name($plugin_cookies), true);
